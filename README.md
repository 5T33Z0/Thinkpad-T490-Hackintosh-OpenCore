...
> [!CAUTION]
> 
> Upgrading from to macOS 14.3.1 to 14.4 via `System Update` causes a Kernel Panic during install! You can follow this [workaround](https://github.com/5T33Z0/OC-Little-Translated/blob/main/W_Workarounds/macOS14.4.md) to install macOS 14.4 on a new APFS volume. Use Migration Manager afterwards to get your data onto the new volume!
...
**BIOS** | **UEFI**: v1.81 (2023-10-26) <br> **Embedded Controller**: v1.27
